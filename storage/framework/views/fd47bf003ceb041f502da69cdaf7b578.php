...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.main-container','data' => ['title' => 'Station Officers','breadcrumbs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Station Officers','breadcrumbs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['url' => route('admin.dashboard'), 'label' => 'Dashboard'],
        ['label' => 'Station Officers']
    ])]); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['primary' => true,'label' => 'Add Officer','icon' => 'plus','wire:click' => 'create']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Search by station or name...','icon' => 'magnifying-glass','wire:model.live' => 'search']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="bg-white dark:bg-secondary-900 shadow-md rounded-xl overflow-hidden">
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-secondary-200">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->officers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $officer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['rounded' => true,'icon' => 'pencil','wire:click' => 'edit(\''.e($officer->id).'\')']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['rounded' => true,'negative' => true,'icon' => 'trash','wire:click' => 'delete(\''.e($officer->id).'\')']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
        ...
        <div class="p-4"><?php echo e($this->officers->links()); ?></div>
    </div>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($editing ? 'Edit' : 'Add').' Station Officer','wire:model' => 'modal']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\WireUi\Components\Button\Base::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['primary' => true,'label' => 'Save','wire:click' => 'save','spinner' => 'save']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?><?php /**PATH C:\Users\elvon\Herd\base-app\storage\framework\views/livewire/views/54065fc9.blade.php ENDPATH**/ ?>